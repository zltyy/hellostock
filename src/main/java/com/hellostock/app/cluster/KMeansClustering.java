...
//        	if(isNaN(nowCenter) && maxClusterTimes <= 1000){
//        		this.maxClusterTimes += 100;
//        		initCenter(dataArray,nowCenter,K);
//        	}
    ...
    public abstract boolean isNaN(List<T> nowCenter);
    public abstract void initCenter(List<T> dataArray,List<T> nowCenter,int k);  
    /** 
     * @param o1 
     * @param o2 
     * @return 
